<template>
    <div
        id="sidebar"
        class="grid h-screen max-w-sm border-r border-gray-300/10 bg-gray-50 dark:bg-gray-900 bg-opacity-[0.85]"
    >
        <div class="app-region-drag">
            ...
            <div class="mx-5 my-2 h-px bg-black dark:bg-white opacity-20"></div>
        </div>
        <div class="app-region-drag">
            <div
