        ...
        <div class="w-1/2 text-black dark:text-white">
            ...
            <div v-if="isLoggedIn()" class="flex items-center justify-between bg-gray-800 py-4 px-5 rounded-lg my-12">
                ...
                <div class="flex items-center">
                    <img
                        class="app-region-no-drag h-16 w-16 rounded-lg"
                        :src="
                    ...
                    />
                    <div class="ml-6">
                        <div class="font-semibold text-xl mb-0.5">{{ userAccount?.profile?.nickname }}</div>
                        <div class="text-xs">
                            <span v-if="userAccount?.account?.vipType !== 0" class="flex items-center">
                                <img
                                    class="h-3 mr-1"
                                    ...
                                    alt="vip"
                                />
                                <span class="opacity-70">黑胶VIP</span>
                            </span>
                            <span v-else class="opacity-70">{{ userAccount.profile?.signature }}</span>
                        </div>
                    </div>
                </div>
                <!-- Right part -->
            ...
            <div class="mt-12 font-semibold">
                ...
                <p class="mt-1">
                    MADE BY
                    <a href="https://github.com/soratanmer" target="_blank" class="hover:underline"
                        >SORATA FUJISAWA</a
                    ></p
                >
            </div>
